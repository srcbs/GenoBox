...
def interleave(pe1, pe2, out, format):
...
if __name__ == '__main__':
   ...
   parser = argparse.ArgumentParser(description='''
      Mix reads from two pe-files and create an interleaved zipped file
      ''')
   ...
   parser.add_argument('out', help='output interleaved file (gzipped)')
   ...
   interleave(args.i[0], args.i[1], args.out, args.format)
